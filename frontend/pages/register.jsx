      ...
      <div className="lg:flex">
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          ...
          <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            <p
              ref={errRef}
              className={errMsg ? "my-4 errmsg" : "hidden"}
              aria-live="assertive"
            >
              {errMsg}
            </p>
            ...
            <div className="mt-4">
              <form onSubmit={(e) => handleSubmit(e)}>
                <div>
                  ...
                  <input
                    ref={userRef}
                    className="w-full text-lg px-2 py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                    type="name"
                    value={name}
                ...
                <div className="mt-10">
                  ...
                  <input
                    className="w-full  px-2 text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                    type="password"
                    value={password}
